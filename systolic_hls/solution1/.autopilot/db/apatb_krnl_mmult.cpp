...
// wrapc file define:
#define AUTOTB_TVIN_gmem "../tv/cdatafile/c.krnl_mmult.autotvin_gmem.dat"
#define AUTOTB_TVOUT_gmem "../tv/cdatafile/c.krnl_mmult.autotvout_gmem.dat"
// wrapc file define:
#define AUTOTB_TVIN_a "../tv/cdatafile/c.krnl_mmult.autotvin_a.dat"
#define AUTOTB_TVOUT_a "../tv/cdatafile/c.krnl_mmult.autotvout_a.dat"
// wrapc file define:
#define AUTOTB_TVIN_b "../tv/cdatafile/c.krnl_mmult.autotvin_b.dat"
#define AUTOTB_TVOUT_b "../tv/cdatafile/c.krnl_mmult.autotvout_b.dat"
// wrapc file define:
#define AUTOTB_TVIN_c "../tv/cdatafile/c.krnl_mmult.autotvin_c.dat"
#define AUTOTB_TVOUT_c "../tv/cdatafile/c.krnl_mmult.autotvout_c.dat"
// wrapc file define:
#define AUTOTB_TVIN_a_row "../tv/cdatafile/c.krnl_mmult.autotvin_a_row.dat"
#define AUTOTB_TVOUT_a_row "../tv/cdatafile/c.krnl_mmult.autotvout_a_row.dat"
// wrapc file define:
#define AUTOTB_TVIN_a_col "../tv/cdatafile/c.krnl_mmult.autotvin_a_col.dat"
#define AUTOTB_TVOUT_a_col "../tv/cdatafile/c.krnl_mmult.autotvout_a_col.dat"
// wrapc file define:
#define AUTOTB_TVIN_b_col "../tv/cdatafile/c.krnl_mmult.autotvin_b_col.dat"
#define AUTOTB_TVOUT_b_col "../tv/cdatafile/c.krnl_mmult.autotvout_b_col.dat"

#define INTER_TCL "../tv/cdatafile/ref.tcl"

// tvout file define:
#define AUTOTB_TVOUT_PC_gmem "../tv/rtldatafile/rtl.krnl_mmult.autotvout_gmem.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_a "../tv/rtldatafile/rtl.krnl_mmult.autotvout_a.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_b "../tv/rtldatafile/rtl.krnl_mmult.autotvout_b.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_c "../tv/rtldatafile/rtl.krnl_mmult.autotvout_c.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_a_row "../tv/rtldatafile/rtl.krnl_mmult.autotvout_a_row.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_a_col "../tv/rtldatafile/rtl.krnl_mmult.autotvout_a_col.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_b_col "../tv/rtldatafile/rtl.krnl_mmult.autotvout_b_col.dat"
...
extern "C" void krnl_mmult_hw_stub_wrapper(volatile void *, volatile void *, volatile void *, int, int, int);

extern "C" void apatb_krnl_mmult_hw(volatile void * __xlx_apatb_param_a, volatile void * __xlx_apatb_param_b, volatile void * __xlx_apatb_param_c, int __xlx_apatb_param_a_row, int __xlx_apatb_param_a_col, int __xlx_apatb_param_b_col) {
    ...
    string AESL_num;{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 1; j < e; j += 1, ++i) {((long long*)__xlx_apatb_param_a)[j*8+0] = gmem_pc_buffer[i].range(63,0).to_int64();
...
((long long*)__xlx_apatb_param_a)[j*8+7] = gmem_pc_buffer[i].range(511,448).to_int64();
            ...
            for (int j = 0, e = 1; j < e; j += 1, ++i) {((long long*)__xlx_apatb_param_b)[j*8+0] = gmem_pc_buffer[i].range(63,0).to_int64();
...
((long long*)__xlx_apatb_param_b)[j*8+7] = gmem_pc_buffer[i].range(511,448).to_int64();
            ...
            for (int j = 0, e = 1; j < e; j += 1, ++i) {((long long*)__xlx_apatb_param_c)[j*8+0] = gmem_pc_buffer[i].range(63,0).to_int64();
...
//a_row
aesl_fh.touch(AUTOTB_TVIN_a_row);
aesl_fh.touch(AUTOTB_TVOUT_a_row);
//a_col
aesl_fh.touch(AUTOTB_TVIN_a_col);
aesl_fh.touch(AUTOTB_TVOUT_a_col);
//b_col
aesl_fh.touch(AUTOTB_TVIN_b_col);
aesl_fh.touch(AUTOTB_TVOUT_b_col);
...
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVIN_a_row, __xlx_sprintf_buffer.data());
  {
    sc_bv<32> __xlx_tmp_lv = *((int*)&__xlx_apatb_param_a_row);

    std::string s(__xlx_tmp_lv.to_string(SC_HEX));
    aesl_fh.write(AUTOTB_TVIN_a_row, s.append("\n")); 
  }
...
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVIN_a_col, __xlx_sprintf_buffer.data());
  {
    sc_bv<32> __xlx_tmp_lv = *((int*)&__xlx_apatb_param_a_col);

    std::string s(__xlx_tmp_lv.to_string(SC_HEX));
    aesl_fh.write(AUTOTB_TVIN_a_col, s.append("\n")); 
  }
...
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVIN_b_col, __xlx_sprintf_buffer.data());
  {
    sc_bv<32> __xlx_tmp_lv = *((int*)&__xlx_apatb_param_b_col);

    std::string s(__xlx_tmp_lv.to_string(SC_HEX));
    aesl_fh.write(AUTOTB_TVIN_b_col, s.append("\n")); 
  }
...
krnl_mmult_hw_stub_wrapper(__xlx_apatb_param_a, __xlx_apatb_param_b, __xlx_apatb_param_c, __xlx_apatb_param_a_row, __xlx_apatb_param_a_col, __xlx_apatb_param_b_col);
